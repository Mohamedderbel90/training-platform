 ...
 * to be the trainee's only page, so `/trainee` itself can become the
 * new Dashboard home (see components/dashboard). */
function TraineeDaysContent() {
...
export default function TraineeDaysPage() {
  return (
